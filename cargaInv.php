...
<head>
    ...
    <!--Titulo de la página-->
    <title>Carga de inventario 1</title>
...
<body>
    ...
    <br>
    <div class="contenido" id="formulario1">
        <form class="form-login" action="lecturaExcel.PHP" method="post" enctype="multipart/form-data">
            <div style="text-align:center;">
                <br>
                <img id="archivo" src="img/iconos/inv1.png" height="200" width="200">
                <br>
                <br>
                <input type="file" name="archivo" accept=".xlsx" required=""><br><br>
                <button class="buttons">Cargar Excel Inventario 1</button>
                <br>
            </div>
        </form>
    </div>

    <div class="contenido" id="formulario2">
        <form class="form-login" action="lecturaExcel2.PHP" method="post" enctype="multipart/form-data">
            <div style="text-align:center;">
                ...
                <br>
                <input type="file" name="archivo" accept=".xlsx" required=""><br><br>
                <button class="buttons">Cargar Excel Inventario 2</button>
                <br>
            </div>
        </form>
    </div>
